...
class _$AppDataBase extends PersonDataBase {
  ...
  Future<List<Person>> findAllPersons() async {
    return _queryAdapter.queryList('SELECT *FROM Person',
        mapper: (Map<String, Object> row) =>
            Person(row['id'] as int, row['name'] as String, row['age'] as String));
  }

  @override
  Future<Person> deleteAllPersons(int id) async {
